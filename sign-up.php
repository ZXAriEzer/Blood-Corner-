...
$status=1;
    ...
    $ret="select EmailId from tblblooddonors where EmailId=:email";
...
if($query -> rowCount() == 0)
{
$sql="INSERT INTO  tblblooddonors(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status,Password) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status,:password)";
