...
if (strlen($_SESSION['bbdmsdid']==0)) {
 ...
 if(isset($_POST['update']))
  ...
  $sql="update tblblooddonors set FullName=:name,MobileNumber=:mno, Age=:age,Gender=:gender,BloodGroup=:bloodgroup,Address=:address,Message=:message  where id=:uid";
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					...
					<form action="#" method="post">
						<?php
$uid=$_SESSION['bbdmsdid'];
$sql="SELECT * from  tblblooddonors where id=:uid";
$query = $dbh -> prepare($sql);
$query->bindParam(':uid',$uid,PDO::PARAM_STR);
$query->execute();
