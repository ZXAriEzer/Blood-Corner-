...
$sql="SELECT tblbloodrequirer.BlooddonorID,tblbloodrequirer.name,tblbloodrequirer.EmailId,tblbloodrequirer.ContactNumber,tblbloodrequirer.BloodRequirefor,tblbloodrequirer.Message,tblbloodrequirer.ApplyDate,tblblooddonors.id as donid,tblblooddonors.FullName,tblblooddonors.MobileNumber,tblblooddonors.BloodGroup  from  tblbloodrequirer join tblblooddonors on tblblooddonors.id=tblbloodrequirer.BlooddonorID where tblblooddonors.FullName like '%$sdata%' || tblblooddonors.MobileNumber like '%$sdata%'";
